...
export const getCategoryProducts = async (slug, sort, order, page) =>  await axios.post(`${process.env.REACT_APP_API}/category/${slug}`,{
    sort, 
    order, 
    page
})
...
export const getCategoryProductsCount = async (slug) =>  await axios.get(`${process.env.REACT_APP_API}/category/total/:${slug}`)
